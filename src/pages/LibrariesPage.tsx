        ...
        <div className="max-w-7xl mx-auto px-6">
          <motion.div {...fade}>
            ...
            <p className="text-lg text-muted-foreground mt-6 max-w-2xl leading-relaxed">
              Modern libraries are digital hubs — not just book repositories. We build the technology infrastructure that supports public computing, digital literacy programs, maker spaces, and community engagement.
            </p>
