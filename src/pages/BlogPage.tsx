          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-px bg-border">
            {blogPosts.map((post, i) => (
              ...
              >
                <Link
                  to={`/blog/${post.slug}`}
                  className="block bg-card hover:bg-card-hover p-8 h-full border-t-2 border-t-transparent hover:border-t-primary transition-all duration-250 snap-curve group"
                >
