      ...
      <section className="pt-32 pb-20 border-b border-border">
        <div className="max-w-7xl mx-auto px-6">
          <motion.div {...fade}>
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-medium uppercase mt-3 max-w-4xl">Manufacturing IT</h1>
            <p className="text-lg text-muted-foreground mt-6 max-w-2xl leading-relaxed">
              Industrial-grade technology infrastructure for factory floors, warehouses, and production environments — where downtime means lost revenue and safety risks.
            </p>
