...
import heroImg from "@/assets/industry-hero-government.jpg";
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <IndustryHero
        image={heroImg}
        title="Government IT"
        description="Secure, compliant technology infrastructure for state, county, and municipal government — built for transparency, citizen service, and the unique procurement requirements of the public sector."
