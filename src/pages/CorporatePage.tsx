        ...
        <div className="max-w-7xl mx-auto px-6">
          <motion.div {...fade}>
            ...
            <p className="text-lg text-muted-foreground mt-6 max-w-2xl leading-relaxed">
              Enterprise-grade IT infrastructure without enterprise-grade complexity. We help corporate organizations scale their technology operations with confidence, security, and predictable costs.
            </p>
