      ...
      <section className="pt-32 pb-20 border-b border-border">
        <div className="max-w-7xl mx-auto px-6">
          <motion.div {...fade}>
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-medium uppercase mt-3 max-w-4xl">Real Estate Technology</h1>
            <p className="text-lg text-muted-foreground mt-6 max-w-2xl leading-relaxed">
              Smart building infrastructure that attracts premium tenants, reduces operating costs, and positions your properties as technology-forward assets in a competitive market.
            </p>
